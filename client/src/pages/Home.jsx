...
if(data?.length>0) { return data.map((post)=> <Card key={post._id} {...post}/>)
  ...
  return (
    <h2 className="mt-5 font-bold text-[#6469ff] tex-xl uppercase">{title}</h2>
  )
}
...
const Home = () => {
    ...
    // we're making a call to get all of the posts
    useEffect(()=>{
   const fetchPosts = async() => {
   setLoading(true);
   try {
    // we'll try to get a new response
