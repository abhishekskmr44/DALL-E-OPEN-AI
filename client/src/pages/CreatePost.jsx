...
//   if prompt form and photo exist
  if(form.prompt && form.photo){
    setLoading(true);

    try {
        // we can call our post image route
        const repsonse = await fetch('http://localhost:8080/api/v1/post',{
           method:'POST',
           headers:{
            'Content-Type':'application/json',
           },
        ...
        // await response shows we have got it successfully
        await response.json();
        alert('Success');
        // finally we can go back to home to see our image
        navigate('/');
...
//  if we don't have form.prompt && form.photo
else{
